  ...
  return (
    <div className="card">
      ...
      {loading ? <p>Caricamento…</p> : (
        view === "month"
          ? <MonthView year={year} month={month} byDay={byDay} onPick={setSelected} />
          : <WeekView weekStart={weekStart} byDay={byDay} onPick={setSelected} />
      )}
...
function MonthView({ year, month, byDay, onPick }) {
    ...
    <>
      ...
      <div className="gcal-grid">
        ...
        {Array.from({ length: daysInMonth }).map((_, i) => {
          ...
          return (
            <div key={d} className={`gcal-cell${key === todayKey ? " today" : ""}`}>
...
function WeekView({ weekStart, byDay, onPick }) {
    ...
    <div style={{ overflowX: "auto" }}>
      <div className="wcal">
        ...
        {days.map((d) => {
          ...
          return (
            <div key={key} className={`wcal-head${key === todayKey ? " today" : ""}`}>
